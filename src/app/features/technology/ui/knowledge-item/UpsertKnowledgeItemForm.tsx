...
import { Col, Flex, Form, Image, Input, Radio, Rate, Row } from 'antd';
...
import { KnowledgeGroupSelect } from '../knowledge-group';
import { TechnologySelect } from '../technology';

const { splitFileUrl } = FileTool;

interface Props {
  form: FormInstance<UpsertKnowledgeItemFormEntity>;
  onFinish?: (values: UpsertKnowledgeItemFormEntity) => void;
  technologySectionId?: string;
  technologyType?: TechnologyType;
}

function UpsertKnowledgeItemForm({
  form,
  onFinish,
  technologySectionId,
  technologyType,
  ...
  const technologyId = Form.useWatch('technologyId', form);
  ...
  return (
    <Form<UpsertKnowledgeItemFormEntity>
      form={form}
      initialValues={{
    ...
    >
      <Row gutter={16}>
        <Col span={24}>
          <Form.Item<UpsertKnowledgeItemFormEntity>
            label="Name ~"
            name="name"
            rules={[{ required: true }]}
          >
        ...
        <Col span={12}>
          ...
          >
            <TechnologySelect
              onChange={() => {
                form.resetFields(['knowledgeGroupId']);
              }}
        ...
        <Col span={24}>
          <Form.Item<UpsertKnowledgeItemFormEntity>
            ...
            name="content"
          >
            <Input.TextArea placeholder="Enter content ~" rows={3} />
          </Form.Item>
        </Col>
      ...
      {showPreviewCard ? (
        <Form.Item<UpsertKnowledgeItemFormEntity> noStyle shouldUpdate>
          {({ getFieldsValue }) => {
...
export default UpsertKnowledgeItemForm;
