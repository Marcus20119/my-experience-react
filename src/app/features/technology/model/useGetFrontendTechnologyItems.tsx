...
export const useGetFrontendTechnologyItems = () => {
  const { t } = useTranslation();

  const configurationItems: ThreeDTicketProps[] = [
    {
      color1: '#59a9f6',
      color2: '#9f51f7',
      color3: '#b634f7',
      description: t('technology.description.vite'),
      icon: <Icon height="64" icon="vscode-icons:file-type-vite" width="64" />,
      rate: 4.5,
      title: 'Vite',
    },
    {
  ...
  const otherTechnologyItems: ThreeDTicketProps[] = [
    {
      color1: '#729b1b',
      color2: '#b8cc8e',
      color3: '#fcc72b',
  ...
  const uiItems: ThreeDTicketProps[] = [
    {
      color1: '#4285eb',
      color2: '#29cdff',
      color3: '#f74a5c',
  ...
  return { configurationItems, otherTechnologyItems, uiItems };
};
